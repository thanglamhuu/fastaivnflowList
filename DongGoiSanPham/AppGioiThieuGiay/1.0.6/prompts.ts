  ...
  lifestyle: {
    ...
    scenes: [
      ...
      },
      {
        ...
        video_action_context: '8-second slow sideways camera slide revealing the second shoe. Gentle window light, shoes stationary and sharply focused. Audio / ASMR: quiet room tone, faint curtain or fabric rustle only if visible. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
  ...
  conversion: {
    ...
    scenes: [
      { id: 'cv_1', label: 'Toàn bộ đôi giày 3/4', lockType: 'product_only',
        ...
        video_action_context: '8-second short smooth camera arc from front three-quarter toward side. Both shoes still, fully visible and unchanged. Audio / ASMR: quiet studio room tone, no impact while both shoes remain still. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.' },
      { id: 'cv_2', label: 'Góc bên thấy form và đế', lockType: 'product_only',
        ...
        video_action_context: '8-second static side-profile with a small lateral camera slide. Shoe grounded; silhouette and sole edge remain identical. Audio / ASMR: near-silent studio ambience, no footstep or fabric sound without visible action. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.' },
      ...
      { id: 'cv_4', label: 'Gót giày từ phía sau', lockType: 'product_only',
        ...
        video_action_context: '8-second slow camera drift from rear center to slight rear three-quarter. Both shoes stationary, no fabricated heel details. Audio / ASMR: quiet studio room tone, no fabricated heel clicks. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.' },
      { id: 'cv_5', label: 'Mang giày đi vài bước', lockType: 'product_and_feet',
        ...
        video_action_context: '8-second low-angle lookbook tracking shot. Begin on the side profile, then follow two measured steps with plausible sole contact on level ground; keep both shoes in frame. Audio / ASMR: two soft, synchronized footsteps matching visible sole contact with the walkway. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.' },
      { id: 'cv_6', label: 'Hero shot chừa chỗ đặt giá', lockType: 'product_only',
        ...
        video_action_context: '8-second steady slow push-in toward the grounded shoes. Left text-safe space remains empty; no generated copy, speech or logos. Audio / ASMR: quiet studio ambience and a light airy transition, no spoken price or offer. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.' }
    ]
  },
  studio: {
    id: 'studio',
    ...
    scenes: [
      {
        ...
        video_action_context: '8-second short camera arc around the stable pedestal, revealing side and heel. Constant soft lighting, both shoes fixed and identical. Audio / ASMR: soft studio room tone and a very subtle camera pass, no invented impacts. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second gentle lateral camera slide; only loose background fabric moves slightly. Shoes stay grounded, still and sharp. Audio / ASMR: gentle silk rustle matching visible fabric motion, quiet studio room tone. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second slow push-in. One foot pivots slightly while the other stays planted; reflection follows accurately. Shoe details remain consistent. Audio / ASMR: one soft shoe pivot on the glossy floor, quiet room tone. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
      ...
      },
      {
        ...
        video_action_context: '8-second slow push-in. Background spotlight brightens gently while key light on the still shoes stays constant. Audio / ASMR: near-silent studio room tone, gentle airy emphasis as the camera approaches. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second close-up macro pass across one real visible shoe detail. Hand brushes the detail once; focus follows the contact point without changing product structure. Audio / ASMR: close fingertip brushing the real shoe material once, with texture-appropriate friction. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      }
    ]
  },
  editorial: {
    ...
    scenes: [
      {
        ...
        video_action_context: '8-second stable product shot with very slow push-in. Leave text-safe areas empty; shoe stays still and sharp. Audio / ASMR: quiet studio ambience, subtle airy camera movement with no invented product sound. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
      ...
      },
      {
        ...
        video_action_context: '8-second medium shot. Character settles both feet naturally; camera drifts slightly toward the shoes. Consistent anatomy and footwear. Audio / ASMR: gentle sofa fabric rustle and a soft shoe contact with the floor. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second top-down shot with a very slow zoom-in; background circles move gently without covering the fixed shoes. Audio / ASMR: very subtle graphic whoosh synchronized to the moving circles, no product impact. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
  ...
  creative: {
    ...
    scenes: [
      ...
      },
      {
        ...
        video_action_context: '8-second gentle rising camera move revealing pedestal heights and side profiles; shoes remain fixed and grounded. Audio / ASMR: soft fabric rustle from the visible drape and quiet studio room tone. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second fixed camera; background graphic lines animate subtly toward the still photorealistic shoes. Audio / ASMR: light, understated graphic whoosh timed to the background lines, product stays silent. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second slow sideways camera move. Neon background shifts gently, neutral product light stays constant; shoes remain grounded. Audio / ASMR: faint electric ambience from the visible neon lights, no exaggerated buzzing. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
        ...
        video_action_context: '8-second stable low-angle shot. Seated character changes foot position once; camera makes a small push-in. Background lights move subtly, shoes remain consistent. Audio / ASMR: soft shoe repositioning on the floor and low ambient room tone, no music. Sounds occur only with their visible source, at natural volume. No dialogue, voiceover, on-screen text or background music.'
      },
      {
