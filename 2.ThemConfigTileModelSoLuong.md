...
Đảm bảo rằng Interface ProjectConfi trong file types.ts 
...
và constants.ts trong app hiện tại có khai báo đầy đủ các biến: 
...
Nếu thiếu, hãy tự động bổ sung cho hợp lệ.